...
def make_T018_rcol() :
    ...
    m.AddRCol(name="rc1", length=1, horizontalWidth=200, verticalWidth=200,
              xsize=50, ysize=100,
              material="IRON",
              outerMaterial="AIR")
    ...
    m.AddRCol(name="rc2", length=1, horizontalWidth=200, verticalWidth=200,
              xsize=100, ysize=50,
              material="IRON",
              outerMaterial="AIR")
    ...
    m.AddRCol(name="rc3", length=1, horizontalWidth=200, verticalWidth=200,
              xsize=0, ysize=0,
              material="IRON",
              outerMaterial="AIR")
    ...
    m.AddRCol(name="rc4", length=1, horizontalWidth=200, verticalWidth=200,
